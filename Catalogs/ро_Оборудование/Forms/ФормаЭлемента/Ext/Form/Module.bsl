...
&НаКлиенте
Процедура регЦенВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	Если Элемент.ТекущийЭлемент.Имя	= "регЦенРабота" Тогда
		СтандартнаяОБработка = Ложь;
		ПоказатьЗначение(,Элементы.регЦен.ТекущиеДанные.Работа);
	КонецЕсли;
КонецПроцедуры
