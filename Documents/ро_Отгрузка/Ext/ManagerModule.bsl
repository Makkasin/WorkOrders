...
Функция ДанныеШапка(ссДок,ЦепочкаКА=Ложь)
	...
	| ВЫБРАТЬ                                         
				   ...
				   |LEFT OUTER JOIN Справочник.Контрагенты.КонтактнаяИнформация КАК КонтрагентыКонтактнаяИнформацияКА  ON КонтрагентыКонтактнаяИнформацияКА.ссылка  = тблКА.Контрагент
