...
Функция ЗначенияРеквизитовОбъекта(Ссылка, Знач Реквизиты, ВыбратьРазрешенные = Ложь, КодЯзыка = Неопределено) Экспорт
	...
	ИначеЕсли ТипЗнч(Реквизиты) = Тип("Массив")
		...
		КонецЦикла;
	Иначе
		ВызватьИсключение "ru = 'Неверный тип второго параметра Реквизиты в функции ОбщегоНазначения.ЗначенияРеквизитовОбъекта: %1'";
	КонецЕсли;
...
Функция ПолучитьПараметрыДокумента(Ссылка)
	...
	ЕстьРучнаяКорректировка	= ЕстьРеквизитОбъекта("РучнаяКорректировка", МетаданныеДокумента);
	...
	Результат	= ЗначенияРеквизитовОбъекта(Ссылка, ИменаРеквизитов);
