...
Процедура ОборудованиеПриИзмененииНаСервере()
	Справочники.ПечатныеФормы.ДобавитьКнопкиПечати(ЭтаФорма,Объект.Оборудование,Перечисления.ВидыДокументовДЛяПечФорм.Испытания,Объект.Контрагент);
КонецПроцедуры
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.УстановитьЦену.Видимость = РольДоступна("изменятьЦены");
КонецПроцедуры
...
Процедура УстановитьЦену(Команда)
	оо = Новый ОписаниеОповещения("ПослеВводаУстЦены",ЭтотОбъект);
	ПоказатьВводЧисла(оо,Объект.Цена,"Введите цену",10,2);
КонецПроцедуры

&НаКлиенте
Процедура ПослеВводаУстЦены(Зн,ДопПар) Экспорт
