...
Процедура тблОбрЦенаПриИзмененииНаСервере(КА,Обр,Цена,ОписаниеПараметров)
...
Процедура тблОбрЦенаПриИзменении(Элемент)
	...
	тблОбрЦенаПриИзмененииНаСервере(Контрагент,текСтр.Оборудование,текСтр.Цена,текСтр.ОписаниеПараметров);
	ВидимостьКрасныхЦен();
КонецПроцедуры
...
Процедура тблОбрВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.имя <> "тблОбрЦена" и Поле.имя <> "тблОбрОписаниеПараметров" Тогда
		СтандартнаяОбработка = Ложь;
